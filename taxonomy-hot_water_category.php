	...
	<div class="container">
		<section id="primary" class="site-content">
			<div id="content" role="main">
					...
					<?php
                    // the query                    
                    //to fetch the terms related to the taxonomy
                    //we are doing this to fetch posts of associated category / term in their respective category or taxonomy archive 
                    $terms = get_the_terms( $post->ID, 'hot_water_category' );
                    if ( !empty( $terms ) ){
                        // get the first term
                        //this provides us the category /taxonomy term of the loaded page 
                        $term = array_shift( $terms );
                        $oterm = $term->slug;
                    }
                    new WP_Query(
                        array('post_type'=>'hot_water_system',
                            'tax_query' => array(
                            array(
                                'taxonomy' => 'hot_water_category',
                                'field' => 'slug',
                                'terms' => $oterm   
                            )),
                            'post_status'=>'publish', 
