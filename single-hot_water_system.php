                                ...
                                <div class="container">
                                    <div class="breadcrumbs-innerpage">
                                        <div class="back-link">
                                            ...
                                            $terms = get_the_terms( get_the_ID(), 'hot_water_category' );
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <?php
                                        ...
                                        $customTaxonomyTerms = wp_get_object_terms( $post->ID, 'hot_water_category', array('fields' => 'ids') );
                                        //query arguments
                                        $args = array(
                                            'post_type' => 'hot_water_system',
                                            'post_status' => 'publish',
                                            'posts_per_page' => 4,
                                            'orderby' => 'rand',
                                            'tax_query' => array(
